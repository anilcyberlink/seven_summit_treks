                                ...
                                @foreach ($data as $row)
                                    <tr>
                                        ...
                                        <td class="text-truncate" style="max-width: 200px;">
                                            <a href="{{ route('admin.insurance.detail',$row->id) }}">
                                                {{ $row->full_name }}
                                            </a>
                                        </td>
                                        ...
                                        <td >
                                            <form action="{{ route('admin.insurance.delete', $row->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this record?');">
                                                @csrf
                                                @method('DELETE')
