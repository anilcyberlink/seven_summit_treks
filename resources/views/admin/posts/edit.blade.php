        ...
        <div class="col-md-9">
          ...
          @if ($parent_post->count() > 0)
                  <div class="form-group">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                          ...
                          <div class="col-lg-9">
                            <div class="bs-component">
                              <input type="text" id="inputStandard" name="meta_title" class="form-control" value="{{ $data->meta_keyword }}" />
                            </div>
              ...
              <div class="col-md-3">
                ...
                <div class="sid_bvijay mb10">
                  <label class="field text">
                    <input type="text" id="inputStandard" name="banner_caption" class="form-control" placeholder="Banner Caption" value="{{ $data->banner_caption }}" />   
                  </label>
                </div>
                ...
                <div class="sid_bvijay mb10">
                  <label class="field text">
                    <input type="text" id="inputStandard" name="thumbnail_caption" class="form-control" placeholder="Thumbnail Caption" value="{{ $data->thumbnail_caption }}" />   
                  </label>
                </div>
