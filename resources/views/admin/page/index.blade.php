            ...
            <tr class="id{{$row->id}}">
              ...
              <td class="post_title title_hi_sh">                
                ...
                <td>
                 ...
                 @elseif(Request::segment(2) == 'imp-links-trekking')
                 <a class="copy_text"  data-toggle="tooltip" title="Copy to Clipboard" href="{{'https://www.sevensummittreks.com/info/imp-links-trekking/'.$row->uri}}">Copy Link</a>
