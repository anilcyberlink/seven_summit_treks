    ...
    <div id="main">
        ...
        <header class="navbar navbar-fixed-top">
            <div class="navbar-branding">
                <a class="navbar-brand" href="{{ url('/') }}" target="_blank">
                    ...
                    @else
                    <img src="{{ asset('themes-assets/images/blank_logo.png') }}" alt="{{ config('app.name') }}" />
                    @endif
                </a>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <li class="dropdown-footer">
                        <a class="animated animated-short fadeInUp" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
        ...
        <aside id="sidebar_left" class="nano nano-primary affix">
            ...
            <div class="sidebar-left-content nano-content">
                ...
                <ul class="nav sidebar-menu">
                   ...
                   <li class="{{ (Request::segment(2) == 'dashboard')?'active':'' }}">
                    ...
                    <li class="">
                       @if(Request::segment(2) == 'posttype' || Request::segment(2) == 'postcategory' || Request::segment(2) == 'company' || Request::segment(2) == 'partners' || Request::segment(2) == 'blog' || Request::segment(2) == 'article' || Request::segment(2) == 'policyconditions' || Request::segment(2) == 'contact-us'|| Request::segment(2) == 'options')
                    ...
                    <li class="">
                    @if(Request::segment(2) == 'pagetype' || Request::segment(2) == 'terms-and-conditions' || Request::segment(2) == 'gear-list' || Request::segment(2) == 'travel-insurane' || Request::segment(2) == 'embassies-and-consulates' || Request::segment(2) == 'expedition-permit-fees' || Request::segment(2) == 'visa-fee'|| Request::segment(2) == 'faq')
                    <a class="accordion-toggle menu-open">
                    @else
                     <a class="accordion-toggle">
                        @endif
            ...
            <li class="">
                ...
                <li class="">
               @if(Request::segment(2) == 'expedition-group'||Request::segment(2) == 'expedition'||Request::segment(1) == 'admin-geographical-facts-index')
                    <a class="accordion-toggle menu-open">
                    @else
                     <a class="accordion-toggle">
                             @endif
                ...
                <ul class="nav sub-nav">
                  <li class="{{ (Request::segment(2) == 'expedition-group')?'active':'' }}">
                    <a href="{{ route('expedition-group.index') }}">
                      <span class="fa fa fa-arrows-h"></span>
                    Expedition Group              
                    </a>                
                  </li>               
                 <li class="{{ (Request::segment(2) == 'expedition')?'active':'' }}">
                    <a href="{{ route('expedition.index') }}">
                      <span class="fa fa fa-arrows-h"></span>
                      Expeditions                 
                    </a>                
                  </li> 
                    <li class="{{ (Request::segment(1) == 'admin-geographical-facts-index')?'active':'' }}">
                      <a href="{{ route('facts') }}">
                    ...
                    <?php */?>
                      <li class="{{ (Request::segment(2) == 'region')?'active':'' }}">
                    ...
                    <!--<li class="{{ (Request::segment(2) == 'itinerary-category')?'active':'' }}">-->
                    <!--    <a href="{{ route('itinerary-category.create') }}">-->
                    ...
                    <!--<li class="{{ (Request::segment(2) == 'itinerary-category')?'active':'' }}">-->
                    <!--     <a href="{{ route('category.post') }}">-->
                    <!--         <span class="fa fa-info text-info"></span>-->
                    <!--         <span class="sidebar-title">Itinerary Category</span>-->
                    <!--     </a>-->
                    <!-- </li>-->

                   <li class="{{ (Request::segment(2) == 'trip'||Request::segment(2) == 'trip-region'||Request::segment(2) == 'trip-expedition')?'tripactive':'tripactive' }}">
                    ...
                    <li class="">
                   @if(Request::segment(1) == 'admin-trip-review'||Request::segment(1) == 'admin-trip-booking'||Request::segment(1) == 'admin-contact-us'||Request::segment(2) == 'subscriber'||Request::segment(1) == 'admin-trip-inquiry')
                    <a class="accordion-toggle menu-open">
                    @else
                     <a class="accordion-toggle">
                             @endif
                ...
                <li class="{{ (Request::segment(1) == 'admin-trip-review')?'active':'' }}">
                 ...
                 <li class="{{ (Request::segment(1) == 'admin-contact-us')?'active':'' }}">
                  ...
                  <li class="{{ (Request::segment(2) == 'subscriber')?'active':'' }}">
                ...
                <li class="{{ (Request::segment(1) == 'admin-trip-inquiry')?'active':'' }}">
                  <a href="{{ route('trip-inquiry') }}">
                    ...
                    <li class="{{ (Request::segment(1) == 'admin-travel-guide-index'||Request::segment(1) == 'admin-travel-guide'||Request::segment(1) == 'admin-travel-guide-edit')?'active':'' }}">
                      ...
                      <li class="">
                        @if(Request::segment(2) == 'videogallery'||Request::segment(2) == 'videocategory')
                    <a class="accordion-toggle menu-open">
                    @else
                     <a class="accordion-toggle">
                             @endif
...
/* ?>
          ...
          <li class="">
                   @if(Request::segment(1) == 'newsletter-create' || Request::segment(1) == 'subscriber-create'|| Request::segment(1) == 'send-newsletter'|| Request::segment(1) == 'subscriber-index'|| Request::segment(1) == 'subscriber-edit'|| Request::segment(1) == 'newsletter-index'|| Request::segment(1) == 'newsletter-edit')
                    ...
                    <ul class="nav sub-nav">
                     ...
                     <li class="{{ (Request::segment(2) == 'settings')?'active':'' }}">
                       ...
                       <li class="{{ (Request::segment(2) == 'payment-index')?'active':'' }}">
                   ...
                   <li class="{{ (Request::segment(2) == 'settings')?'active':'' }}">
                        ...
                        <li class="{{ (Request::segment(2) == 'settings')?'active':'' }}">
                        <a href="{{ url('/laravel-filemanager?type=pdf') }}">
                            <span class="fa fa-cog text-info"></span>
...
<script>
  $('.textarea').wysihtml5({
    ...
    <script src="{{ asset('vendor/plugins/jvectormap/assets/jquery-jvectormap-us-lcc-en.js') }}">
    </script>
