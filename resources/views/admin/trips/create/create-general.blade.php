        ...
        <div class="panel-body">
            <div class="form-group">
                <div class="col-lg-12">
                    ...
                    <textarea class="form-control" id="textArea3" name="meta_title" rows="1" placeholder="Meta Title">{{ old('meta_title') }}</textarea>
            ...
            <div class="form-group">
                <div class="col-lg-12">
                    ...
                    <textarea class="form-control" id="textArea3" name="meta_description" rows="2" placeholder="Meta Description">{{ old('meta_description') }}</textarea>
