                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="tab_6">
                                        @include('admin.trips.create.create-map')
                                    </div>
                                    <!-- /.tab-pane -->
                                    ...
                                    <div class="tab-pane" id="tab_8">
                                        @include('admin.trips.create.create-route-camps')
                                    </div>
                                    <div class="tab-pane" id="tab_9">
                                        @include('admin.trips.create.create-weather-reports')
                                    </div>
                                     <div class="tab-pane" id="tab_10">
                                        @include('admin.trips.create.create-highlights')
                                    </div>
                                    <!-- /.tab-pane -->
                                </div>
                                <!-- /.tab-content -->
