        ...
        <div class="panel-body">
            <div class="form-group">
                <div class="col-lg-12">
                    ...
                    <textarea class="form-control" name="meta_title" rows="1" placeholder="Meta Title">{{ $data->meta_key }}</textarea>
            ...
            <div class="form-group">
                <div class="col-lg-12">
                    ...
                    <textarea class="form-control" name="meta_description" rows="2" placeholder="Meta Description">{{ $data->meta_description }}</textarea>
