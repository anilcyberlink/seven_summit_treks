...
@section('content')
    ...
    <section class="uk-cover-container  uk-position-relative   uk-flex uk-flex-middle  uk-background-norepeat uk-background-cover uk-background-top-center" uk-parallax="bgy: -100; easing: -2; " data-src="{{asset('uploads/original/'.$data->banner)}}"
				...
				<div class="uk-container    uk-position-relative" uk-scrollspy="cls: uk-animation-fade;  delay: 500; repeat: false">
					<div class=" uk-margin-medium ">
                        <h1 class="uk-text-bolder text-white uk-margin-small"
                            uk-scrollspy="cls: uk-animation-slide-top-small;   delay: 400; repeat: false;">{{$data->post_type}}</h1></div>
                    <div class="uk-width-1-2@m uk-margin-top"
                         uk-scrollspy="cls: uk-animation-slide-top-small;   delay: 800; repeat: false;">
                        <p class="text-white uk-text-lead uk-margin-remove"> {{$data->content}} </p>
                    </div>
                </div>
            </div>
        </div>
   ...
   <div class="uk-container" >
      ...
      <div class="uk-child-width-1-2@m uk-margin-medium-bottom" uk-grid uk-height-match="target:.uk-same-height" uk-scrollspy="cls: uk-animation-slide-left-small; target: h1, a, h3, div;  delay: 50; repeat: false;">
         ...
         <div>
            <div class="uk-padding bg-white uk-border-rounded uk-box-shadow-medium uk-same-height">
               <h2 class="uk-h4 f-w-400 ">Location</h2>
               <div class="uk-flex uk-flex-middle"><i class="fa fa-map-marker fa-2x uk-margin-small-right text-primary"></i>  
                     <a href="{{$setting->google_map}}"  target="_blank" class="text-black">{{ $setting->address }}</a>
                  </div>
            </div>
         </div>
         <!--  -->
          ...
          <div>
            <div class="uk-padding bg-white uk-border-rounded uk-box-shadow-medium uk-same-height">
               <h2 class="uk-h4 f-w-400 ">Contact at</h2>
               <div class="uk-flex uk-flex-middle"><i class="fa fa-phone fa-2x uk-margin-small-right  text-primary"></i> <a href="tel:{{ $setting->phone }}" class="text-black">{{ $setting->phone }}</a> </div>
            </div>
         </div>
         <!--  -->
                  ...
                  <div>
            <div class="uk-padding bg-white uk-border-rounded uk-box-shadow-medium uk-same-height">
               <h2 class="uk-h4 f-w-400 ">Email us</h2>
               <div class="uk-flex uk-flex-middle"><i class="fa fa-envelope fa-2x uk-margin-small-right  text-primary"></i> <a href="mailto:{{ $setting->email_primary }}" class="text-black">{{ $setting->email_primary }}</a></div>
            </div>
         </div>
         <!--  -->
          ...
          <div>
            <div class="uk-padding bg-white uk-border-rounded uk-box-shadow-medium uk-same-height">
               <h2 class="uk-h4 f-w-400 ">Post Box No.</h2>
               <div class="uk-flex uk-flex-middle"><i class="fa fa-envelope-open-o fa-2x uk-margin-small-right  text-primary"></i> <a href="tel:{{ $setting->welcome_text }}" class="text-black">{{ $setting->welcome_text }}</a> </div>
            </div>
         </div>
         <!--  -->
     ...
     <div class="bg-light uk-padding uk-padding-remove-top">
     		<div class="uk-text-center">
                  ...
                  <div>
                     <a class="uk-link uk-icon-button bg-primary text-black" rel="noreferrer" href="{{ $setting->twitter_link }}" target="_blank">
      ...
      <div class="uk-padding bg-white uk-border-rounded uk-box-shadow-medium uk-margin-medium-bottom">
          ...
          <form class="uk-grid" method="post" action="{{route('contact-us')}}" uk-grid >
      ...
      <!-- form end -->
      <!-- map -->
      <div class="uk-margin-medium-top">{!! $setting->google_map2 !!} </div>
      <!-- end map -->
   </div>
</section>
    <!-- section  -->
