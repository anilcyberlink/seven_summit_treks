    ...
    <div class="  uk-clearfix" style="z-index: 1;" uk-sticky="media: 640; offset: 130; bottom: #uk-stop-sticky; ">
        ...
        <!--                <li>-->
        <!--                    <a class="uk-display-block" href="{{ url('team/'.$team->uri.'/'.$row->uri) }}">-->
        <!--                        <div class="uk-grid uk-flex-middle uk-grid-small">-->
        <!--                            <div class="uk-width-1-4">-->
        <!--                                <div class="uk-media-60">-->
        <!--                                     @if($row->thumbnail)-->
        <!--                                    <img src="{{ asset(env('PUBLIC_PATH').'uploads/team/' . $row->thumbnail) }}" alt="" class="uk-border-circle">-->
        <!--                                    @else-->
        <!--                                    <img src="{{ asset(env('PUBLIC_PATH').'themes-assets/images/users.jpg') }}" alt="" class="uk-border-circle">-->
        <!--                                    @endif-->
        <!--                                </div>-->
        <!--                            </div>-->
        <!--                            <div class="uk-width-expand">-->
        <!--                                <h5 class="text-primary theme-font-medium  uk-margin-remove ">{{$row->name}}</h5>-->
