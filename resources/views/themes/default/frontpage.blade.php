...
@section('content')
    ...
    @include('themes.default.common.banner')
   ...
   <section class="bg-light uk-section-small uk-position-relative" uk-scrollspy="cls: uk-animation-slide-left-small;  delay: 100; repeat: false;">
      <div class="uk-container ">
         <!-- for small device -->
         <!--<div class="uk-hidden@m"> <img src="{{asset('uploads/original/'.$settings->first()->mobile_banner_logo)}}" alt="" uk-img> </div>-->
                  <div class="uk-hidden@m"> <img src="{{asset('images/logos Mobile view-01.png')}}" alt="" uk-img> </div>
         <!-- for web device -->
         <!--<div class="uk-visible@m"> <img src="{{asset('uploads/original/'.$settings->first()->banner_logo)}}" alt="" uk-img> </div>-->
        <div class="uk-visible@m"> <img src="{{asset('images/logos web view-02.png')}}" alt="" uk-img> </div>
      ...
      <ul class="uk-slider-items uk-grid-small uk-text-center" uk-grid uk-scrollspy="cls: uk-animation-slide-left-small; target:h1, p, img;  delay: 100; repeat: false;">
       @foreach ($expeditions as $row)
        <li class="uk-item uk-width-5-6 uk-width-1-2@s uk-width-1-4@m uk-active" tabindex="-1" style="">
          <a class="uk-list-shine uk-corner-hover uk-cover-container uk-display-block" tabindex="0" href="{{ route('page.expeditionlist', $row->uri) }}">
            <div class="uk-media-520">
                @if ($row->thumbnail)
                <img class="uk-image" alt="{{ $row->title }}" uk-img src="{{ asset('uploads/original/' . $row->thumbnail) }}">
                @else
                <img class="uk-image" alt="{{ $row->title }}" uk-img src="{{ asset('themes-assets/images/blank.png') }}">
                @endif
              <!-- corner -->
            ...
            <div class="uk-position-center">
              <div class="uk-overlay">
                <h1 class="main-title-font  uk-margin-remove text-primary">  {{ $row->title }}</h1>
                <p class="uk-margin-remove  text-white">{!! $row->sub_title !!}</p>
              </div>
            </div>
          </a>
        </li>
...
<section class="uk-section   uk-position-relative  bg-white uk-hidden@s">
  <div class="uk-container ">
     ...
     @foreach ($expeditions->take(3) as $row)
      <div>
        <a class="uk-list-shine uk-corner-hover uk-cover-container  uk-display-block" href="{{ route('page.expeditionlist', $row->uri) }}">
          <div class="uk-media-520">
           @if ($row->thumbnail)
            <img class="uk-image" alt="{{ $row->title }}" uk-img src="{{ asset('uploads/original/' . $row->thumbnail) }}">
            @else
    ...
    <div class="uk-position-relative uk-visible-toggle  uk-slider uk-slider-container" tabindex="-1" style="padding-right:0; padding-top:20px;" uk-slider="sets: false; finite: true;" uk-parallax="">
      <ul class="uk-slider-items uk-grid-small uk-text-center" uk-grid uk-scrollspy="cls: uk-animation-slide-left-small; target:h1, p, img;  delay: 100; repeat: false;">
      @foreach ($expeditions->skip(3) as $row)
        <!--  -->
        <li class="uk-item uk-width-5-6 uk-width-1-2@s uk-width-1-4@m uk-active " tabindex="-1" style="">
          <a class="uk-list-shine uk-corner-hover uk-cover-container uk-display-block" tabindex="0" href="{{ route('page.expeditionlist', $row->uri) }}">
            <div class="uk-media-520">
...
<?php /*?>
    ...
    <?php */?>
    <!-- section -->
    @include('themes.default.common.14peaks')
    <!-- end section -->
  ...
  <section class="uk-section-large uk-padding-remove-top  uk-position-relative ">
   <div class="uk-container">
      <div class="bg-white   uk-box-shadow-medium uk-border-rounded">
         <!--  -->
           @foreach ($regions->slice(0, 2) as $row)
            @if ($loop->odd)
         <div class="uk-grid-collapse uk-flex-middle  uk-img-effect" uk-grid uk-scrollspy="cls: uk-animation-slide-left-small; target:div;  delay: 100; repeat: false;">
            <div class="uk-width-1-2@m">
               <div class="uk-media-450 uk-animated-after">
                  <a href="{{ url(regionurl($row->uri)) }}"> 
                    @if ($row->banner)
                    <img src="{{ asset('uploads/banners/' . $row->banner) }}" alt="{{ $row->title }}" class="uk-effect-1">
                     @else
                    <img class="uk-image" alt="{{ $row->title }}" uk-img src="{{ asset('themes-assets/images/blank.png') }}">
                  @endif
                 </a>
            ...
            <div class="uk-width-1-2@m">
               <div class="uk-padding">
                  <div class="main-animated-title uk-margin-medium-bottom"> <a href="{{ url(regionurl($row->uri)) }}" class="uk-h3 theme-font-medium-bold text-black">{{ $row->title }}</a> </div>
                   {!! $row->excerpt !!}
                  <a href="{{ url(regionurl($row->uri)) }}" class="uk-flex-middle uk-button-home uk-button-home-primary uk-flex uk-flex-middle" > <span class="uk-icon bg-primary"  ><i class="fa fa-angle-right" aria-hidden="true"></i></span>  Learn More
                  </a> 
               </div>
            </div>
         </div>
      ...
      <div class="uk-margin-top">
         <div class="uk-position-relative uk-visible-toggle  " tabindex="-1" uk-slider="sets: true; finite: true;">
            <ul class="uk-slider-items uk-child-width-1-1 uk-child-width-1-3@s uk-child-width-1-3@m uk-grid-small" uk-grid uk-scrollspy="cls: uk-animation-slide-top-small; target:a;  delay: 300; repeat: false;">
               <!--  -->
                @foreach ($regions->skip(2) as $row)
               <li>
                  <a class="uk-list-shine uk-corner-hover uk-cover-container uk-display-block uk-link-toggle " tabindex="0" href="{{ url(regionurl($row->uri)) }}">
                     <div class="uk-media-300">
                         @if ($row->banner)
                            <img src="{{ asset('uploads/banners/' . $row->banner) }}" alt="{{ $row->title }}" class="uk-image">
                            @else
                            <img class="uk-image" alt="{{ $row->title }}" uk-img src="{{ asset('themes-assets/images/blank.png') }}">
                            @endif
                        <!-- corner -->
                              ...
                              <div class="uk-flex">
                                 ...
                                 <div class="uk-margin-small-bottom">
                                       <div class="uk-show-more uk-h4 theme-font-medium uk-text-justify">
                                        {!! Str::limit($row->review, 300)!!}
                                           <p></p>
                                          <a href="#"  uk-toggle="target:#ReviewDetails{{$loop->iteration}}" class="uk-flex-middle uk-button-home uk-button-home-primary uk-flex uk-flex-middle" >
        ...
        <div class="uk-position-relative uk-visible-toggle  uk-slider uk-slider-container" tabindex="-1" style="padding-right:0; padding-top:20px;" uk-slider="sets: true; finite: true;" uk-parallax="">
          <ul class="uk-slider-items uk-grid-small uk-text-center" uk-grid uk-scrollspy="cls: uk-animation-slide-left-small; target:h1, p, img;  delay: 100; repeat: false;">
           ...
           @foreach($articles as $row)
            <li class="uk-item uk-width-5-6 uk-width-1-2@s uk-width-1-3@m uk-active" tabindex="-1" style="">
              <a class="uk-list-shine uk-corner-hover uk-cover-container uk-display-block" tabindex="0" href="{{ url(geturl($row->uri)) }}">
                <div class="uk-media-520">
                    @if($row->page_thumbnail)
                        <img class="uk-image" alt="{{$row->post_title}}" uk-img src="{{ $row->page_thumbnail ? asset('uploads/original/' . $row->page_thumbnail) : '' }}">
                    @endif
                  <!-- corner -->
                  <div class="uk-corner-borders uk-corner-borders--left"></div>
                  <div class="uk-corner-borders uk-corner-borders--right"></div>
                ...
                <div class="uk-position-center">
                  <div class="uk-overlay">
                    <h1 class="main-title-font  uk-margin-remove text-primary">{{$row->post_title}}</h1>
                  </div>
                </div>
              </a>
            </li>
...
<!--new section -->
   ...
   <div class="uk-hidden@l"> 
      <img src="{{asset('uploads/original/'.$settings->first()->testimonial_img_sm)}}" alt="" uk-img> 
   </div>
   <!-- for small device -->
   <div class="uk-visible@l"> 
      <img src="{{asset('uploads/original/'.$settings->first()->testimonial_img)}}" alt="" uk-img> 
   </div>
</section>
    @endif
            ...
            <div class=" uk-container">
                <div class="uk-main-title   uk-margin-medium-bottom uk-text-left"
                    ...
                    <div class="uk-flex-middle uk-flex-between uk-flex">
                        ...
                        <div> <a href="{{ url(geturl('our-blog')) }}" class="uk-button-home uk-button-home-primary uk-flex uk-flex-middle" uk-scrollspy="cls: uk-animation-slide-top;   delay: 1600; repeat: false;"> 
    ...
    <section class="uk-section bg-white">
        <div class="uk-container">
          ...
          <h4 class=" text-primary uk-margin-remove uk-text-center">
              ...
              <img src="{{ asset('themes-assets/images/icon/verified.png') }}" width="20px">
              </h4>
   ...
   <div class="scene-position">
      <ul id="scene">
         <li class="layer" data-depth="0.1"> <img src="{{asset('uploads/original/'.$settings->first()->animation1)}}" alt="{{ $setting->site_name }}" class="bg-img bg-img-0"> </li>
         <li class="layer" data-depth="0.2"> <img src="{{asset('uploads/original/'.$settings->first()->animation2)}}" alt="{{ $setting->site_name }}" class="bg-img bg-img-1"> </li>
         <li class="layer" data-depth="0.6"> <img src="{{ asset('themes-assets/images/animation/big-clouds.png') }}" alt="{{ $setting->site_name }}" class="bg-img bg-img-2"> </li>
         <li class="layer" data-depth=".8"> <img src="{{ asset('themes-assets/images/animation/big-clouds.png') }}" alt="{{ $setting->site_name }}" class="bg-img bg-img-3"> </li>
      </ul>
   </div>
   <!--  -->
   <div class="uk-container uk-container-small uk-align-center">
      <!--<div class="uk-child-width-1-3@s uk-flex-middle uk-text-center uk-grid" uk-grid uk-scrollspy="cls: uk-animation-slide-left-small; target:div;  delay: 300; repeat: false;">-->
        <div class="uk-child-width-expand@s uk-flex-middle uk-text-center uk-grid" uk-grid uk-scrollspy="cls: uk-animation-slide-top-small; target:div, path;  delay: 50; repeat: false;">
         <div>
            <h1 class="uk-h3 theme-font-medium-bold"> {{ $setting->text1 }}</h1>
         </div>
         ...
         <div>
            ...
            <img src="{{asset('themes-assets/images/ssummit.png')}}" style="height:90px; width:auto;">
         ...
         <div>
            <h1 class="uk-h3 theme-font-medium-bold">{{ $setting->text2 }}</h1>
         </div>
      </div>
   </div>
</section>
      ...
      <form class="uk-grid-medium uk-floating-form" uk-grid id="subscribe_newsletter">
         ...
         <div class="uk-width-2-2@s">
            <div class="uk-text-small">
               ...
               <a target="_blank" rel="noopener" href="{{route('unsubscribe')}}">unsubscribe</a> from our newsletter whenever you want to. You can also view our privacy policy 
               <a target="_blank" rel="noopener" href="{{ url(geturl('privacy-policy')) }}">here in detail</a>.</p>
            </div>
         </div>
         <div class="uk-width-1-2@s">
