...
@section('content')
                        ...
                        <div class="uk-grid uk-grid-small uk-child-width-expand uk-flex-nowrap uk-flex-middle" uk-grid="">
                           ...
                           <div>
                              <div>
                                 ...
                                 <p class="uk-margin-remove"><a href="{{ url('/weather-report/' . weather_report($data->id)) }}">Live Weather Report</a></p>
                              </div>
                           </div>
                        </div>
                     </div>
   ...
   <div class=" uk-container">
                              ...
                              <div class="uk-width-1-1">
                                 <h5 class="uk-margin-remove theme-font-medium">  {{ $row->title }} </h5>
                                   ...
                                   <div class="uk-flex uk-flex-middle uk-grid-small" uk-grid>
                                       ...
                                       <div class="uk-itinerary-small-title"><i class="fa fa-cutlery text-primary uk-margin-small-right" aria-hidden="true"></i>  <span>{{ $row->meals }}</span></div>
                                    </div>
                                    @endif
                                    @if($row->accomodation)
                                    <div class="uk-margin-remove-top">
                                   ...
                                   @if($row->distance)
                                    <div class="uk-margin-remove-top">
                                       <div class="uk-itinerary-small-title"><i class="fa fa-road text-primary uk-margin-small-right" aria-hidden="true"></i>  <span>{{$row->distance}}</span></div>
                                    </div>
                                    @endif
                                    @if($row->elevation)
                                    <div class="uk-margin-remove-top">
                                       <div class="uk-itinerary-small-title"><i class="fa fa-area-chart text-primary uk-margin-small-right" aria-hidden="true"></i>  <span>{{$row->elevation}}</span></div>
                                    </div>
                                    @endif
    ...
    <!-- start Map -->
    @if ($trip_maps && $trip_maps->count() > 0)
        <div id="map" class="uk-single-section">
            ...
            <div class="swiper-container map-carousel">
                <div class="swiper-wrapper" uk-lightbox="animation: slide">
                    @foreach ($trip_maps as $row)
                        <div class="swiper-slide" data-slide-type="img">
                            <div class="hero-items">
                                <a class="uk-inline hero-itemsa"  href="{{ asset('uploads/original/' . $row->thumbnail) }}">
    ...
    <div id="gears-list" class="uk-single-section">
        ...
        <div class="uk-grid-small uk-child-width-1-2@s uk-text-center uk-margin-medium-top"  uk-grid="masonry: true">
            ...
            <div>
                  ...
                  @if(get_trip_guide($data->id) && get_trip_guide($data->id)->link )
                    <a class="uk-list-shine uk-cover-container uk-transition-toggle uk-display-block uk-link-toggle "
            ...
            <div>
             ...
             @if(get_trip_insurance($data->id) && get_trip_insurance($data->id)->link)
                 <a class="uk-list-shine uk-cover-container uk-transition-toggle uk-display-block uk-link-toggle "
            ...
            <div>
                 ...
                 @if(get_trip_payment($data->id) && get_trip_payment($data->id)->link)
                <a class="uk-list-shine uk-cover-container uk-transition-toggle uk-display-block uk-link-toggle "
                ...
                <div class="uk-media-150 uk-list-shine">
                 ...
                 <div class="uk-overlay-primary uk-position-cover"></div>
                    <h2 class="seo-h2-heading seo-translateX-0 uk-position-center uk-light uk-margin-remove text-white"
                        style="z-index: 1;">+ {{ $loop->remaining }}</h2>
                @endif
                </div>
                </a>
             </li>
