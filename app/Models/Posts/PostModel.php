...
class PostModel extends Model
{
    ...
    protected $fillable = [
        ...
        'post_tags', 'status', 'is_footer', 'published', 'is_active', 'is_draft', 'is_trashed', 'show_in_home', 'is_password_protected',
        'is_commentable', 'lang','associated_title','banner_caption','thumbnail_caption'
    ];
