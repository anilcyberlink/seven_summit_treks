...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $footer2 = PostModel::where(['post_type' => 1, 'post_parent' => 0,'status'=>1])->get();
        $footer = PostModel::where(['post_type' => 1, 'post_parent' => 0,'status'=>1, 'is_footer' => 1])->get();
        ...
        'regions' => $regions, 'partners' => $partners, 'footers' => $footers,'popular'=>$popular,'footer'=>$footer,'footer2' => $footer2]);
    }
}
