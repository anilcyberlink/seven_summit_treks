  ...
  // dd($request->all());
    ...
    if (isset($request->itinerary_ordering)) {
      ...
      foreach ($keys as $key) {
        ...
        $tripItinerary->distance=$request->distance[$key];
        $tripItinerary->elevation=$request->elevation[$key];
        $tripItinerary->save();
        $sn_itinerary++;
      }
    }
    ...
    if (isset($request->itinerary_ordering)) {
      ...
      foreach ($keys as $key => $value) {
        ...
        if ($request->itinerary_id[$value] == "") {
          ...
          $itineraryData->distance=$request->distance[$key];
          $itineraryData->elevation=$request->elevation[$key];
          $itineraryData->save();
