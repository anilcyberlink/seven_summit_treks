...
//  For mail testing by sangam
//  use Illuminate\Support\Facades\Mail;
//  Route::get('/send-test-email', function () {
//     \Mail::raw('This is a test email from Mailtrap!', function ($message) {
//         $message->to('sangam.cyberlink@gmail.com') // Change to your email for testing
//                 ->subject('Test Email');
//     });
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::resources([
        ...
        'admin.trip-map' => 'AdminControllers\Travels\TripMapController',
    ...
    Route::put('post-footer/{id}', 'AdminControllers\Posts\PostController@postFooter')->name('admin.post.footer');
    ...
    Route::post('admin/maps_thumb_update/{id}', 'AdminControllers\Travels\TripMapController@maps_thumb_update')->name('maps_thumb_update');
    ...
    Route::delete('delete_maps_thumb/{id}', 'AdminControllers\Travels\TripMapController@delete_maps_thumb')->name('delete_maps_thumb');
