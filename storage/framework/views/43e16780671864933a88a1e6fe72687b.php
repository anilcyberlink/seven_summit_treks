        ...
        <div class="uk-container uk-position-relative">
            ...
            <div class="uk-grid-medium" uk-grid
                uk-scrollspy="cls: uk-animation-slide-left-small; target:.uk-article;  delay: 300; repeat: false;">
                 <?php if($latest_article_post): ?>
                    <div class="uk-position-relative uk-width-1-1">
                        <a class="uk-article uk-inline-clip uk-link-toggle uk-width-1-1" href="<?php echo e(url(geturl($latest_article_post->uri))); ?>">
                            <div class="uk-overlay-primary  uk-position-cover"></div>
                            <div class="uk-media-500"> 
                            <?php if($latest_article_post->page_thumbnail): ?>
                            <img class="uk-image" uk-img="" alt="<?php echo e($latest_article_post->post_title); ?>"
                                    src="<?php echo e(asset('uploads/original/' . $latest_article_post->page_thumbnail)); ?>"> 
                            <?php else: ?>
                              <img class="uk-image" uk-img="" alt="<?php echo e($latest_article_post->post_title); ?>"
                                ...
                                <div class="uk-text-left uk-position-z-index">
                                    <div class="uk-width-1-2@m text-white">
                                        <div class="text-white uk-h5 uk-margin-top uk-margin-remove-bottom">
                                            <?php echo e(dateformat($latest_article_post->post_date)); ?>

                                        </div>
                                        <h2
                                            class="text-white  theme-font-medium-bold uk-margin-small-top uk-margin-small-bottom ">
                                            <?php echo e($latest_article_post->post_title); ?>

                                        </h2>
                                        <?php echo $latest_article_post->post_excerpt; ?>
                ...
                <!--  -->
				  ...
				  <div class=" uk-child-width-1-2@s uk-child-width-1-3@m  uk-grid-medium uk-grid" uk-grid=""
                    ...
                    <?php if($articles->count() > 0): ?>
                        <?php $__currentLoopData = $articles->slice(1,12); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div>
                ...
                <!--  -->
                <?php echo e($articles->links('themes.default.common.paginate')); ?>
...
<?php echo $__env->make('themes.default.common.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sevensummittreks/public_html/resources/views/themes/default/template-article.blade.php ENDPATH**/ ?>