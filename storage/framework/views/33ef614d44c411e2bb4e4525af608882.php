...
<a href="<?php echo e(route('subscriber.create')); ?>" class="btn btn-primary btn-sm">Add Subscriber</a>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($value->verified==0 ? 'Not Verified' : 'Verified'); ?></td>
                                    <td>
                                    <a href="<?php echo e(route('subscriber.update',$value->id)); ?>">Edit</a>
                                    <a href="<?php echo e(route('subscriber.delete',$value->id)); ?>">Delete</a>
                                    </td>
                                </tr>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sevensummittreks/public_html/resources/views/admin/user-index.blade.php ENDPATH**/ ?>