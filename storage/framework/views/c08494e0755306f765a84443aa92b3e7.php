...
<?php $__env->startSection('content'); ?>
    ...
    <section class="uk-cover-container  uk-position-relative   uk-flex uk-flex-middle  uk-background-norepeat uk-background-cover uk-background-top-center" uk-parallax="bgy: -100; easing: -2;  "
             data-src="<?php echo e(asset('uploads/banners/' . $data->banner)); ?>" uk-height-viewport="expand: true; min-height: 500;" uk-img>
            ...
            <div class="uk-width-1-1 uk-position-relative" style="z-index: 99;">
                <div class="uk-container    uk-position-relative" uk-scrollspy="cls: uk-animation-fade;  delay: 500; repeat: false">
                    <div class=" uk-margin-medium uk-width-large">
                        <h1 class="theme-font-extra-bold text-white uk-margin-small" uk-scrollspy="cls: uk-animation-slide-top-small;   delay: 400; repeat: false;"><span class="uk-text-bold">Trip Booking</span> </h1>
                    </div>
                </div>
            </div>
        </div>
                     ...
                     <div class="uk-booking bg-white uk-border-rounded uk-card uk-card-default  uk-overflow-hidden">
                        <div class="uk-booking-header bg-primary">
                            <div class="uk-grid uk-flex uk-flex-middle uk-grid-small" uk-grid>
                                ...
                                <div class="uk-width-expand@m">
                                    <h2 class="uk-h3 uk-margin-remove text-white  main-title-font"><?php echo e($data->trip_title); ?></h2>
                                    <div class="uk-selected-brief text-white" id="desc"><?php echo e($data->sub_title); ?></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="uk-width-1-1">
                                <h4 class="uk-text-bold  text-primary uk-heading-bullet uk-margin-remove ">
                                 ...
                                 <div class="uk-width-1-2@s">
                                    <label class="uk-margin-small uk-display-block">Full Name <span class="text-red">*</span></label>
                                    <input class="uk-input" name="full_name" type="text" placeholder="" required>
                                </div>
                                  
                                  
                                  <div class="uk-width-1-2@s">
                                    <label class="uk-margin-small uk-display-block">Email Address <span class="text-red">*</span></label>
                                    <input class="uk-input" name="email" type="email" placeholder="" required>
                                </div>
                   ...
                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                 ...
                                 <div class="uk-width-1-1">
                                     <div class="uk-booking-trip">
                                        <ul class="font-size-small uk-tab-booking uk-tab" data-uk-tab="{connect:'#hometab'}" uk-scrollspy="cls: uk-animation-slide-left-small; target:a;  delay: 100; repeat: false">

                                            <?php if($data->expeditions->isNotEmpty()): ?>
                                                <li class="uk-active"><a href="" class="theme-font-extra-bold" aria-expanded="true" >Expedition</a></li>
                                            <?php else: ?>
                                        ...
                                        <ul id="home-tab" class="uk-switcher">
                                            ...
                                            <li class="uk-active">
                                                <div>
                                                    <label class="uk-margin-small uk-display-block">Expedition  <span class="text-red">*</span></label>
                                                    <select name="expedition_id" id="tour_name" class="uk-select">
                                                        <option <?php if($data->expeditions->first()->pivot->trip_id==$data->id): ?> <?php endif; ?> selected value="<?php echo e($data->id); ?>"><?php echo e($data->trip_title); ?></option>
                                                    </select>
                                                </div>
                                            </li>
                                            <?php else: ?>
                                            <li class="">
                                                <div>
                                                    <label class="uk-margin-small uk-display-block">Trip Name <span class="text-red">*</span></label>
                                                    <select name="trip_id" id="tour_name" class="uk-select">
                                                        <option value="<?php echo e($data->id); ?>" selected><?php echo e($data->trip_title); ?></option>
                                                    </select>
                                                </div>
                                            </li>
                                             <?php endif; ?>
                                  ...
                                  <div class="uk-width-1-2@s">
                                    ...
                                    <input class="uk-input" name="arrival_date" type="date" placeholder="">
                                </div>
                                  
                                  
                                 <div class="uk-width-1-2@s">
                                    <label class="uk-margin-small uk-display-block">Final Depature Date</label>
                                    <input class="uk-input" name="departure_date" type="date" placeholder="">
                                </div>
                                ...
                                <div class="uk-width-1-1@s">
                                    <label class="uk-margin-small uk-display-block">Let us know all your inquiries and we will get back to you shortly</label>
...
<?php echo $__env->make('themes.default.common.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sevensummittreks/public_html/resources/views/themes/default/booking_page2.blade.php ENDPATH**/ ?>