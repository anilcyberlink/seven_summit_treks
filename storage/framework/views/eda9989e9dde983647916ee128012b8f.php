            ...
            <div class="sidebar-left-content nano-content">
                ...
                <ul class="nav sidebar-menu">
                   ...
                   <li class="<?php echo e((Request::segment(2) == 'dashboard')?'active':''); ?>">
                    ...
                    <li class="">
                       <?php if(Request::segment(2) == 'posttype' || Request::segment(2) == 'postcategory' || Request::segment(2) == 'company' || Request::segment(2) == 'partners' || Request::segment(2) == 'blog' || Request::segment(2) == 'article' || Request::segment(2) == 'policyconditions' || Request::segment(2) == 'contact-us'|| Request::segment(2) == 'options'): ?>
               ...
               <?php if(Request::segment(2) == 'expedition-group'||Request::segment(2) == 'expedition'||Request::segment(1) == 'admin-geographical-facts-index'): ?>
                ...
                <li class="<?php echo e((Request::segment(1) == 'admin-trip-inquiry')?'active':''); ?>">
                  <a href="<?php echo e(route('trip-inquiry')); ?>">
                    ...
                    <li class="">
                        <?php if(Request::segment(2) == 'medical-assessment' || Request::segment(2) == 'accident-waiver' || Request::segment(2) == 'insurance'): ?>
                            <a class="accordion-toggle menu-open">
                        <?php else: ?>
                            <a class="accordion-toggle">
                        <?php endif; ?>
                        ...
                        <ul class="nav sub-nav">
                            <li class="<?php echo e((Request::segment(2) == 'medical-assessment')?'active':''); ?>">
                                <a href="<?php echo e(route('admin.medical')); ?>">
                                    <span class="fa fa-arrows"></span>
                                    Medical Assessment
                                </a>
                            </li>
                            <li class="<?php echo e((Request::segment(2) == 'accident-waiver')?'active':''); ?>">
                                <a href="<?php echo e(route('admin.accident')); ?>">
                                    <span class="fa fa-arrows"></span>
                                    Accident Waiver
                                </a>
                            </li>
                            <li class="<?php echo e((Request::segment(2) == 'insurance')?'active':''); ?>">
                                <a href="<?php echo e(route('admin.insurance')); ?>">
                                    <span class="fa fa-arrows"></span>
                                    Insurance
                                </a>
                            </li>
...
<?php /**PATH D:\xampp\htdocs\seven_summit\resources\views/admin/master.blade.php ENDPATH**/ ?>