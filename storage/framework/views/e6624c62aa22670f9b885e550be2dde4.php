...
<section class="uk-section bg-white">
    <div class=" uk-container">
        <form id="multiStepForm" action="<?php echo e(route('accident-waiver-success')); ?>" enctype="multipart/form-data" method="POST">
            <?php echo csrf_field(); ?>
            <!-- form 1 start -->
...
<?php echo $__env->make('themes.default.common.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\seven_summit\resources\views/themes/default/accident-waiver.blade.php ENDPATH**/ ?>