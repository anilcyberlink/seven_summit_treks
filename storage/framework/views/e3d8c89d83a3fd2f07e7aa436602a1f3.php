...
<?php $__env->startSection('content'); ?>
    ...
    <!-- end banner -->
    	<!-- section -->
	<section class="uk-section bg-light uk-position-relative uk-wave-grey-top" uk-scrollspy="cls: uk-animation-slide-left-small; target: h1,p;  delay: 100; repeat: false;">
		<div class="uk-container">
			<!--<h1 class="uk-h2 theme-font-medium-bold text-black">Partner with Nepal’s largest and most trusted operator for Himalayan Expeditions</h1>-->
                            ...
                            <div class="uk-width-expand@m">
                                <div class="uk-padding-large uk-text-justify">
                                    ...
                                    <div class="uk-margin-small-bottom">
                                        <h2 class="uk-h2 theme-font-medium-bold text-black"> <?php echo e($row->post_title); ?> </h2>
                                    </div>
    ...
    <!-- end section -->
    		<!-- section -->
	<section class="uk-section bg-light uk-position-relative uk-wave-grey-top" uk-scrollspy="cls: uk-animation-slide-left-small; target: h1,ul,p;  delay: 100; repeat: false;">
		<div class="uk-container">
...
<?php echo $__env->make('themes.default.common.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sevensummittreks/public_html/resources/views/themes/default/template-partnership-with-sst.blade.php ENDPATH**/ ?>