...
<?php if($message->banner): ?>
	...
	<div class="uk-cover-container uk-image-blur uk-position-relative uk-flex uk-flex-bottom uk-background-norepeat uk-background-cover uk-background-center" uk-parallax="bgy: -100; easing: -2;  " data-src="<?php echo e(asset(env('PUBLIC_PATH').'uploads/team/' . $message->thumbnail)); ?>" uk-height-viewport="expand: true; min-height: 600;" uk-img> </div>
        <?php endif; ?>		<div class="uk-overlay-primary  uk-position-cover "></div>
		<div class="uk-hero-banner-content-inner  uk-position-bottom-center uk-position-z-index">
			<div class="uk-width-xlarge uk-text-center">
				<div class="uk-padding uk-padding-remove-left uk-padding-remove-right uk-text-center">
					<div class="team__single__image uk-margin-auto" uk-scrollspy="cls: uk-animation-slide-top-small;   delay: 800; repeat: false;"> <img src="<?php echo e(asset(env('PUBLIC_PATH').'uploads/team/' . $message->thumbnail)); ?>" alt=""> </div>
					<h1 class="seo-h1-heading main-title-font uk-text-bolder text-primary uk-margin-top uk-margin-remove-bottom" uk-scrollspy="cls: uk-animation-slide-top-small;   delay: 1200; repeat: false;"> 
               <?php echo e($message->name); ?>

            </h1>
					<h4 class="text-white  uk-text-bolder uk-margin-remove-top  uk-margin-small-bottom" uk-scrollspy="cls: uk-animation-slide-top-small;   delay: 1600; repeat: false;">Chairman </h4>
					<ul class="uk-child-width-1-2@s uk-text-center uk-grid-small   text-white  uk-margin-medium-bottom" uk-grid uk-scrollspy="cls: uk-animation-slide-left-small; target:div;  delay: 100; repeat: false;">
						<li>
							<div><span class=" uk-margin-small-right" uk-icon="icon: receiver;"></span> <?php echo e($message->phone); ?></div>
						</li>
						<li>
							<div> <span class="uk-margin-small-right" uk-icon="icon: mail;"></span> <?php echo e($message->email); ?></div>
						</li>
					</ul>
	...
	<section class="uk-section uk-team-single bg-black-light uk-position-relative ">
		<div class="uk-container uk-container-small text-white ">
			...
			<div  class="uk-margin-medium-bottom" uk-scrollspy="cls: uk-animation-slide-left-small; target:div,  li, img, p, h1, tr;  delay: 50; repeat: false;">
				...
				<h2 class="uk-h3 theme-font-medium-bold uk-text-bold text-white uk-heading-line uk-margin-medium"><span>Mountains Summitted by  <?php echo e($message->name); ?></span></h2>
			...
			<div>
				<h2 class="uk-h3 theme-font-medium-bold uk-text-bold text-white uk-heading-line uk-margin-medium"><span>Certificates & Awards Of <?php echo e($data->name); ?></span></h2>
...
<?php echo $__env->make('themes.default.common.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sevensummittreks/public_html/resources/views/themes/default/template-teamSingle.blade.php ENDPATH**/ ?>