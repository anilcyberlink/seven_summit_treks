                        ...
                        <table class="table admin-form table-striped dataTable" id="datatable3">
                            <thead>
                                <tr class="bg-light">
                                    ...
                                    <th>Post Name</th>
                                    <th>Status</th>
                                    <?php if(getPostTypeIdByUri(Request::segment(2)) == 1 && Request::segment(3) == null): ?>
                                        <th>Is Footer?</th>
                                    <?php endif; ?>
                                    <th>Order</th>
                                    <th></th>
                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="id<?php echo e($row->id); ?>">
                                        ...
                                        <?php if(getPostTypeIdByUri(Request::segment(2)) == 1 && Request::segment(3) == null): ?>
                                            <td>
                                                <?php if($row->post_parent == 0): ?>
                                                    <input class="CheckFooter" type="checkbox" name="is_footer" data-rowid="<?php echo e($row->id); ?>" <?php echo e(($row->is_footer == 1)?'checked':''); ?> />
                                                <?php else: ?>
                                                    -
                                                <?php endif; ?>
                                            </td>
...
<?php $__env->startSection('libraries'); ?>
    ...
    <script type="text/javascript">
        ...
        $('.CheckFooter').on('click',function(e){
            var csrf = $('meta[name="csrf-token"]').attr('content');
            var id = $(this).attr('data-rowid');
            var url  = '<?php echo e(route("admin.post.footer",["id"=>':id'])); ?>';
            url = url.replace(':id',id);
            $.ajax({
                type:'put',
                url:url,
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\seven_summit\resources\views/admin/posts/index.blade.php ENDPATH**/ ?>