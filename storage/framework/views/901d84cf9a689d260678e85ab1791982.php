...
<html lang="en">
<head>
    <title><?php if (! empty(trim($__env->yieldContent('meta_keyword')))): ?> <?php echo $__env->yieldContent('meta_keyword'); ?> - <?php endif; ?> <?php echo e($setting->site_name); ?></title>
    <link rel="canonical" href="<?php echo e(getCanonicalUrl()); ?>">
    <meta charset="utf-8">
     <meta name="theme-color" content="#e1a74e">
   <meta name="title" content="<?php echo $__env->yieldContent('meta_keyword'); ?>">
    ...
    <meta property="og:image" content="<?php echo e(asset( env('PUBLIC_PATH') . 'uploads/original/' )); ?>/<?php echo $__env->yieldContent('thumbnail'); ?>"/>
    <?php else: ?>
    <meta property="og:image" content="<?php echo e(asset(env('PUBLIC_PATH').'/images')); ?>/logo.svg"/>
    <?php endif; ?>
    <meta property="og:image:width" content="1000"/>
    <meta property="og:image:height" content="600"/>
    <meta name="twitter:image" content="<?php echo e(asset( env('PUBLIC_PATH') . 'uploads/original/' )); ?>/<?php echo $__env->yieldContent('thumbnail'); ?>"/>
...
<!-- end mobile top menu -->
<div class="uk-main-header uk-navbar-container uk-navbar-transparent" uk-sticky>
<div class="uk-container">
<nav class="uk-navbar d-flex uk-flex-middle" uk-navbar>
    <div class="uk-navbar-left ">
        <a class="uk-navbar-item uk-logo" href="<?php echo e(url('/')); ?>"> 
        <img src="<?php echo e(asset('themes-assets/images/tm-white-logo.png')); ?>" alt="<?php echo e($setting->site_name); ?>" class="uk-logo-white">
            <img src="<?php echo e(asset('themes-assets/images/new-logo.svg')); ?>" alt="<?php echo e($setting->site_name); ?>" class="uk-logo-dark">
            <img src="<?php echo e(asset('themes-assets/images/tm-gold-logo.png')); ?>" alt="<?php echo e($setting->site_name); ?>" class="uk-logo-primary"> </a>
    </div>
            ...
            <?php if($navigations->count()): ?>
                <?php $__currentLoopData = $navigations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($loop->iteration == 1): ?>
                        <li>
                            <a href="#"> <?php echo e($row->post_type); ?>

                                <span class="" uk-icon="icon: chevron-down; ratio: .75;"></span>
                            </a>
                            <div class="uk-navbar-dropdown uk-wave-black-bottom bg-black uk-margin-remove uk-padding-remove uk-border-top"  uk-drop="delay-hide: 10; uk-animation-slide-top-small; duration: 300; boundary: .uk-navbar-container; boundary-align: true; pos: bottom-justify;">
                                <div class="uk-container">
                                        ...
                                        <div class="uk-padding-menu">
                                            <ul class="uk-child-width-1-4 uk-flex" uk-grid uk-scrollspy="cls: uk-animation-slide-top-small; delay: 300; repeat: false;">
                                                ...
                                                <?php if(has_posts($row->id)): ?>
                                                    <?php $__currentLoopData = has_posts($row->id)->chunk(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li>
                                                            <div>
                                                                <ul class="uk-menu-list">
                                                                    <?php $__currentLoopData = $row; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        ...
                                                                        <?php else: ?>
                                                                            <?php if($_row->id == 168): ?>
                                                                                <li>
                                                                                    <a href="<?php echo e(url(geturl($_row->uri))); ?>" style="color:#d62a34!important;"><?php echo e(Str::ucfirst($_row->post_title)); ?></a>
                                                                                </li>
                                                                            <?php else: ?>
                                                                                <li>
                                                                                    <a href="<?php echo e(url(geturl($_row->uri))); ?>"><?php echo e(Str::ucfirst($_row->post_title)); ?></a>
                                                                                </li>
                                                                            <?php endif; ?>
                                                                        <?php endif; ?>
                                                    ...
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php endif; ?>
                                                <!--start: - below code was messing design so it was updated with above code-->
                                                ...
                                                <!--        <a href="<?php echo e(route('all-trip')); ?>" class="uk-button uk-button-white-outline uk-width-1-1">-->
                                                <!--            Book a Trip<span class="uk-icon" uk-icon="icon:arrow-right; ratio: 1.5" uk-scrollspy="cls: uk-animation-slide-right; delay: 400; repeat: false;"></span>-->
                                                <!--        </a>-->
                                                <!--    </div>-->
                                                <!--</li>-->
                                                <!-- -->
...
<!-- start mobile menu -->
  <div id="offcanvas-reveal" class="uk-modal-full" uk-modal>
    ...
    <div>
        <a class="uk-navbar-item uk-logo" href="<?php echo e(url('/')); ?>"> 
        <img src="<?php echo e(asset('/themes-assets/images/tm-gold-logo.png')); ?>" alt="<?php echo e($setting->site_name); ?>" class="uk-logo-light" width="110"> </a>
    </div>
    <div>
  ...
  <nav class="uk-margin-large-top uk-margin-large-bottom">
    ...
    <?php if($company->count()): ?>
        <li class="uk-parent"> <a href="javascript:void(0)">About Us </a>
            <ul class="uknavsub">
                <?php $__currentLoopData = $footer2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php else: ?>
                        <?php if($row->id == 168): ?>
                            <li>
                                <a href="<?php echo e(url(geturl($row->uri))); ?>" style="color:#d62a34!important;"><?php echo e(Str::ucfirst($row->post_title)); ?></a>
                            </li>
                        <?php else: ?>
                            <li>
                                <a href="<?php echo e(url(geturl($row->uri))); ?>"><?php echo e(Str::ucfirst($row->post_title)); ?></a>
                            </li>
                        <?php endif; ?>
                    <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<h2 class="uk-h4 uk-margin-remove">Popular Search</h2>
...
<!--  -->
<main id="app">
<?php /**PATH /home/sevensummittreks/public_html/resources/views/themes/default/common/trip-header.blade.php ENDPATH**/ ?>