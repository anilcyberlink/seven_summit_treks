<div class="col-md-12">
   <div class="panel">
       ...
       <div class="panel-body" id="row_body" style="width:100%;">
       <div class="row">
         ...
         <div class="col-md-1"> <label>Meals</label></div>
          <div class="col-md-1"> <label>Distance</label></div>
          <div class="col-md-1"> <label>Elevation</label></div>
                      ...
                      <?php $__currentLoopData = $itineraries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <div class="row" id="rec-<?php echo e($loop->iteration); ?>">
                              ...
                              <div class="col-md-1">
                                 ...
                                 <div class="col-md-1">
                                  <input type="text" name="distance[]" value="<?php echo e($row->distance); ?>" class="form-control"
                                      placeholder="" />
                              </div>   <div class="col-md-1">
                                  <input type="text" name="elevation[]" value="<?php echo e($row->elevation); ?>" class="form-control"
                                      placeholder="" />
                              </div>
                 ...
                 <input type="hidden" name="itinerary_id[]" value="" />
                   <div class="col-md-1"> <input type="number" min="1" max="2000" name="itinerary_ordering[]"
                           ...
                           <div class="col-md-2"><input type="text" name="itinerary_title[]" class="form-control"
                                   placeholder="" /></div>
                           <div class="col-md-2"><input type="text" name="itinerary_content[]" class="form-control"
                                   placeholder="" /></div>
                       <div class="col-md-2"><input type="text" name="accomodation[]" class="form-control"
                           placeholder="" /></div>

                           <div class="col-md-1"><input type="text" name="itinerary_meals[]" class="form-control"
                                   placeholder="" /></div>
                                   
                         <div class="col-md-1"><input type="text" name="distance[]" class="form-control"
                      placeholder="" /></div>

                      <div class="col-md-1"><input type="text" name="elevation[]" class="form-control"
                      placeholder="" /></div>
