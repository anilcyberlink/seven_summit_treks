    ...
    <?php if($partners->count() > 0): ?>
        <section
            ...
            <div class="uk-container  uk-position-relative">
                <h2 class="text-white uk-h4 uk-margin-small">Partners</h2>
            ...
            <div class="uk-margin-remove-bottom tm-grid-expand uk-grid-large uk-margin-xlarge uk-grid" uk-grid=""
                ...
                <?php if($footer->count(0 > 0)): ?>
                    <div class="uk-width-1-2@s  uk-width-1-2  uk-width-expand@m">
                        <h2 class="uk-h4 text-white uk-text-bold  uk-scrollspy-inview uk-animation-slide-left-small"
                            uk-scrollspy-class="">
                            About Us
                        </h2>
                ...
                <?php if($regions->count() > 0): ?>
                    <div class="uk-width-1-2@s  uk-width-1-2 uk-width-expand@m">
                        <h2 class="uk-h4  text-white uk-text-bold  uk-scrollspy-inview uk-animation-slide-left-small"
                            uk-scrollspy-class="">Trekking</h2>
                        <ul class="uk-list  uk-scrollspy-inview uk-animation-slide-left-small" uk-scrollspy-class="">
                ...
                <?php if($expeditions->count() > 0): ?>
                    <div class="uk-width-1-2@s uk-width-1-2 uk-width-expand@m">
                        <h2 class="uk-h4  text-white uk-text-bold  uk-scrollspy-inview uk-animation-slide-left-small"
                            uk-scrollspy-class="">Expeditions </h2>
                        <ul class="uk-list  uk-scrollspy-inview uk-animation-slide-left-small" uk-scrollspy-class="">
                ...
                <div class="uk-width-1-3@s">
                    <h2 class="uk-h4  text-white uk-text-bold  uk-scrollspy-inview uk-animation-slide-left-small"
                        uk-scrollspy-class=""> <?php echo e($setting->site_name); ?> </h2>
                ...
                <div class="uk-width-auto@m">
                    <div class="uk-child-width-auto uk-flex-left@s uk-flex-center" uk-grid>
                        ...
                        <?php if($setting->instagram_link): ?>
                            <div>
                                <a class="uk-link uk-icon-button bg-primary text-black" rel="noreferrer" href="<?php echo e($setting->instagram_link); ?>" target="_blank">
                                    <svg fill="#262626" width="20" height="20" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
...
<div id="ReviewDetails<?php echo e($loop->iteration); ?>" class="uk-modal" uk-modal>
        <div class="uk-modal-dialog uk-bg-pattern-primary">
            <div class="uk-text-center  uk-padding-remove uk-box-shadow-small">
               ...
               <h2 class="uk-h4 uk-margin-remove theme-font-extra-bold">
                       <?php echo e($row->name); ?>

                  </h2>
                  <h2 class="text-primary uk-margin-remove theme-font-medium uk-h4">
...
</html><?php /**PATH D:\xampp\htdocs\seven_summit\resources\views/themes/default/common/footer.blade.php ENDPATH**/ ?>