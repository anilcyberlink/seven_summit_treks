                                ...
                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="text-truncate" style="max-width: 200px;">
                                            <a href="<?php echo e(route('admin.insurance.detail',$row->id)); ?>">
                                        ...
                                        <td >
                                            <form action="<?php echo e(route('admin.insurance.delete', $row->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this record?');">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\seven_summit\resources\views/admin/forms/insurance.blade.php ENDPATH**/ ?>