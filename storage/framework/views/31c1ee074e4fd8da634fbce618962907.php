                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="tab_6">
                                        <?php echo $__env->make('admin.trips.edit.edit-map', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </div>
...
/******** End For highlights *******/
        ...
        jQuery(document).delegate('button.delete-map', 'click', function(e) {
            ...
            if (makeConfirm == true) {
                ...
                var trip_id = '<?php echo e($data->id); ?>';
                var url =
                    '<?php echo e(route('admin.trip-map.destroy', ['admin' => ':admin', 'trip_map' => ':trip_map'])); ?>';
                url = url.replace(':admin', trip_id);
        ...
        jQuery(document).delegate('.delete_maps_thumb', 'click', function(e) {
            ...
            var csrf = $('meta[name="csrf-token"]').attr('content');
            var id = $(this).attr('href');
            var url = '<?php echo e(route('delete_maps_thumb', ['id' => ':id'])); ?>';
            url = url.replace(':id', id);
            $.ajax({
                type: 'DELETE',
                url: url,
