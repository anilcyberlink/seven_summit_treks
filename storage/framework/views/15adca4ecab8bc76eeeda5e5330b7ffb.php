...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <a href="<?php echo e(url('admin/region')); ?>" class="btn btn-default btn-sm backlink"><i class="fa fa-list"
            aria-hidden="true"></i> Show List </a>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
    <form class="form-horizontal" role="form" action="<?php echo e(url('admin/region/' . $data->id)); ?>" method="post"
                        ...
                        <div class="col-lg-9">
                            <div class="bs-component">
                                <textarea class="form-control my-editor" id="" name="excerpt"
                                    rows="9"><?php echo e($data->excerpt); ?></textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="bs-component">
                                <textarea class="form-control my-editor" id="" name="content"
                                    rows="30"><?php echo e($data->content); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <div class="col-lg-12">
                            <div class="bs-component">
                                <input type="text" class="form-control" name="video" value="<?php echo e($data->video); ?>" />
                                 Video Status : &nbsp;&nbsp; <input type="checkbox" name="video_status" value="1" <?php echo e(($data->video_status)?"checked":""); ?> />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-9">
                            <div class="bs-component">
                                <input type="text" id="" name="meta_keyword" class="form-control"
                                    value="<?php echo e($data->meta_keyword); ?>" placeholder="Meta Key" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="sid_bvijay mb10">
                    <div class="hd_show_con">
                        <div class="publice_edi">
                            Status: <a href="avoid:javascript;" data-toggle="collapse" data-target="#publish_1"><?php echo e($data->status == '1'?'Active':'Inactive'); ?></a>
                        </div>
                    </div>
                    <footer>
...
<?php $__env->startSection('scripts'); ?>
    <script type="text/javascript">
        $('.imagedelete').on('click', function(e) {
            ...
            $.ajax({
                type: 'delete',
                url: "<?php echo e(url('delete_region_banner') . '/'); ?>" + id,
                data: {
                    _token: csrf
                },
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sevensummittreks/public_html/resources/views/admin/regions/edit.blade.php ENDPATH**/ ?>