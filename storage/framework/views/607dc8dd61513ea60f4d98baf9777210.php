...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <a href="<?php echo e(route('admin.post.index', Request::segment(2))); ?>" class="btn btn-default btn-sm backlink">
        <i class="fa fa-list" aria-hidden="true"></i> Show List
    </a>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
    <form class="form-horizontal" role="form" action="<?php echo e(route('admin.post.store', Request::segment(2))); ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-9">
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label for="inputStandard" class="col-lg-2 control-label">Meta Title</label>
                        <div class="col-lg-9">
                            <div class="bs-component">
                                <input type="text" id="" name="meta_title" class="form-control" placeholder="Meta Title" />
                            </div>
                            <small style="color:red; font-weight:bold;"><i>***Character limit 50-60 characters only***</i></small>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <div class="bs-component">
                                <textarea class="form-control" id="textArea3" name="meta_description" rows="3" placeholder="Meta Description"></textarea>
                            </div>
                            <small style="color:red; font-weight:bold;"><i>***Character limit 150–160 characters only***</i></small>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-3">
         ...
         <div class="sid_bvijay mb10">
          <label class="field text">
            <input type="text" id="inputStandard" name="banner_caption" class="form-control" placeholder="Banner Caption" />   
          </label>
        </div>
         ...
         <div class="sid_bvijay mb10">
          <label class="field text">
            <input type="text" id="inputStandard" name="thumbnail_caption" class="form-control" placeholder="Thumbnail Caption" />   
          </label>
        </div>
