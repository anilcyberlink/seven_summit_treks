            ...
            <tr class="id<?php echo e($row->id); ?>">
              ...
              <td class="post_title title_hi_sh">                
                ...
                <td>
                 ...
                 <?php elseif(Request::segment(2) == 'imp-links-trekking'): ?>
                 <a class="copy_text"  data-toggle="tooltip" title="Copy to Clipboard" href="<?php echo e('https://www.sevensummittreks.com/info/imp-links-trekking/'.$row->uri); ?>">Copy Link</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\seven_summit\resources\views/admin/page/index.blade.php ENDPATH**/ ?>