...
<?php $__env->startSection('content'); ?>
                        ...
                        <div class="uk-grid uk-grid-small uk-child-width-expand uk-flex-nowrap uk-flex-middle" uk-grid="">
                           ...
                           <div>
                              <div>
                                 ...
                                 <p class="uk-margin-remove"><a href="<?php echo e(url('/weather-report/' . weather_report($data->id))); ?>">Live Weather Report</a></p>
                              </div>
                           </div>
                        </div>
                     </div>
   ...
   <div class=" uk-container">
         ...
         <div class="uk-width-expand@m" uk-scrollspy="cls: uk-animation-slide-left-small; target:  li, img, p, h1;  delay: 50; repeat: false;">
            ...
            <div  class="uk-single-section">
               ...
               <div class="uk-main-title   uk-margin-medium-bottom uk-display-block uk-text-left">
                  <h2 class="uk-h4 uk-heading-line  uk-text-left  uk-position-relative text-black  uk-text-uppercase uk-margin-remove">
                              ...
                              <div class="uk-width-1-1">
                                 <h5 class="uk-margin-remove theme-font-medium">  <?php echo e($row->title); ?> </h5>
                                   ...
                                   <div class="uk-flex uk-flex-middle uk-grid-small" uk-grid>
                                       ...
                                       <div class="uk-itinerary-small-title"><i class="fa fa-cutlery text-primary uk-margin-small-right" aria-hidden="true"></i>  <span><?php echo e($row->meals); ?></span></div>
                                    </div>
                                    <?php endif; ?>
                                   ...
                                   <?php if($row->distance): ?>
                                    <div class="uk-margin-remove-top">
                                       <div class="uk-itinerary-small-title"><i class="fa fa-road text-primary uk-margin-small-right" aria-hidden="true"></i>  <span><?php echo e($row->distance); ?></span></div>
                                    </div>
                                    <?php endif; ?>
                                    <?php if($row->elevation): ?>
                                    <div class="uk-margin-remove-top">
                                       <div class="uk-itinerary-small-title"><i class="fa fa-area-chart text-primary uk-margin-small-right" aria-hidden="true"></i>  <span><?php echo e($row->elevation); ?></span></div>
                                    </div>
                                    <?php endif; ?>
    ...
    <!-- start Map -->
    <?php if($trip_maps && $trip_maps->count() > 0): ?>
        <div id="map" class="uk-single-section">
            ...
            <div class="swiper-container map-carousel">
                <div class="swiper-wrapper" uk-lightbox="animation: slide">
                    <?php $__currentLoopData = $trip_maps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="swiper-slide" data-slide-type="img">
                            <div class="hero-items">
                                <a class="uk-inline hero-itemsa"  href="<?php echo e(asset('uploads/original/' . $row->thumbnail)); ?>">
                                    <img src="<?php echo e(asset('uploads/original/' . $row->thumbnail)); ?>" alt="<?php echo e($row->title); ?>">
                                </a>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <div class="swiper-button-next" style="background-color: var(--bg-black); border-radius: 100%; padding: 1px 8px;"></div>
                <div class="swiper-button-prev" style="background-color: var(--bg-black); border-radius: 100%; padding: 1px 8px;"></div>
    ...
    <div id="gears-list" class="uk-single-section">
        ...
        <div class="uk-grid-small uk-child-width-1-2@s uk-text-center uk-margin-medium-top"  uk-grid="masonry: true">
            ...
            <div>
                  ...
                  <?php if(get_trip_guide($data->id) && get_trip_guide($data->id)->link ): ?>
                    <a class="uk-list-shine uk-cover-container uk-transition-toggle uk-display-block uk-link-toggle "
            ...
            <div>
             ...
             <?php if(get_trip_insurance($data->id) && get_trip_insurance($data->id)->link): ?>
                 <a class="uk-list-shine uk-cover-container uk-transition-toggle uk-display-block uk-link-toggle "
            ...
            <div>
                 ...
                 <?php if(get_trip_payment($data->id) && get_trip_payment($data->id)->link): ?>
                <a class="uk-list-shine uk-cover-container uk-transition-toggle uk-display-block uk-link-toggle "
            ...
            <?php if($videos->isEmpty()): ?>
             ...
             <li class=" uk-width-1-3@m">
                ...
                <div class="uk-media-150 uk-list-shine">
                 ...
                 <div class="uk-overlay-primary uk-position-cover"></div>
                    <h2 class="seo-h2-heading seo-translateX-0 uk-position-center uk-light uk-margin-remove text-white"
                        style="z-index: 1;">+ <?php echo e($loop->remaining); ?></h2>
                <?php endif; ?>
                </div>
                </a>
             </li>
               ...
               <div class="uk-container uk-position-relative">
                  ...
                  <div class="uk-card uk-card-default toggle-review uk-margin-top" hidden id="toggle-review">
                     <div class="uk-card-header">
                        <!-- title -->
                        <h2 class="uk-h4 uk-text-left  uk-position-relative text-black  uk-text-uppercase uk-margin-remove">
...
<?php echo $__env->make('themes.default.common.trip-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\seven_summit\resources\views/themes/default/tripdetail.blade.php ENDPATH**/ ?>