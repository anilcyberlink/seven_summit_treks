...
<section class="uk-section bg-white">
    <div class=" uk-container">
        <form id="multiStepForm" action="<?php echo e(route('medical-assessment-success')); ?>" enctype="multipart/form-data" method="POST">
            <?php echo csrf_field(); ?>
            <!-- form 1 start -->
                    ...
                    <div class="uk-grid-medium" uk-grid>
                        ...
                        <div class="uk-width-1-2@m uk-width-1-3@l">
                            ...
                            <input class="uk-input" type="date" id="bdate" name="bdate"
                                value="<?php echo e(old('bdate')); ?>" required>
                        </div>
                                ...
                                <li>
                                    <label>
                                        <input type="radio" name="gender" value="male" class="uk-radio uk-margin-small-right"
                                            <?php echo e(old('gender') == 'male' ? 'checked' : ''); ?> required> Male
                                    </label>
                                </li>
                                <li>
                                    <label>
                            ...
                            <ul class="uk-grid uk-grid-small" uk-grid>
                                <li>
                                    <label><input type="radio" name="exercise" value="1" class="uk-radio uk-margin-small-right"
                                                <?php echo e(old('exercise') == '1' ? 'checked' : ''); ?> required> Yes</label>
                                </li>
                                <li>
                                    <label><input type="radio" name="exercise" value="0" class="uk-radio uk-margin-small-right"
                                                <?php echo e(old('exercise') == '0' ? 'checked' : ''); ?>> No</label>
                                </li>
                            </ul>
                        </div>
                        <div class="uk-width-1-1@m uk-width-2-3@l">
                            ...
                            <input class="uk-input" type="text" id="frequency" name="frequency"
                                value="<?php echo e(old('frequency')); ?>" hidden>
                        </div>
                                ...
                                <div class="uk-width-1-2@s">
                                    ...
                                    <ul class="uk-grid uk-grid-small" uk-grid>
                                        <li><label><input type="radio" name="smoke" value="1" class="uk-radio uk-margin-small-right"
                                                        <?php echo e(old('smoke') == '1' ? 'checked' : ''); ?> required> Yes</label></li>
                                        <li><label><input type="radio" name="smoke" value="0" class="uk-radio uk-margin-small-right"
                                                        <?php echo e(old('smoke') == '0' ? 'checked' : ''); ?>> No</label></li>
                                    </ul>
                                </div>
                                <div class="uk-width-1-2@s">
                                    ...
                                    <ul class="uk-grid uk-grid-small" uk-grid>
                                        <li><label><input type="radio" name="alcohol" value="1" class="uk-radio uk-margin-small-right"
                                                        <?php echo e(old('alcohol') == '1' ? 'checked' : ''); ?> required> Yes</label></li>
                                        <li><label><input type="radio" name="alcohol" value="0" class="uk-radio uk-margin-small-right"
                                                        <?php echo e(old('alcohol') == '0' ? 'checked' : ''); ?>> No</label></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="uk-width-1-1@m uk-width-2-3@l">
                            ...
                            <input class="uk-input" type="text" id="drink" name="drink"
                                value="<?php echo e(old('drink')); ?>" hidden>
                        </div>
                        ...
                        <div class="uk-width-1-1@m uk-width-1-3@l">
                            ...
                            <ul class="uk-grid uk-grid-small" uk-grid>
                                <li><label><input type="radio" name="medication" value="1" class="uk-radio uk-margin-small-right"
                                                <?php echo e(old('medication') == '1' ? 'checked' : ''); ?> required> Yes</label></li>
                                <li><label><input type="radio" name="medication" value="0" class="uk-radio uk-margin-small-right"
                                                <?php echo e(old('medication') == '0' ? 'checked' : ''); ?>> No</label></li>
                            </ul>
                        </div>
                        <div class="uk-width-1-1@m uk-width-2-3@l">
                            ...
                            <input class="uk-input" type="text" id="dose" name="dose"
                                value="<?php echo e(old('dose')); ?>" hidden>
                        </div>
                        ...
                        <div class="uk-width-1-1@m uk-width-1-3@l">
                            ...
                            <ul class="uk-grid uk-grid-small" uk-grid>
                                <li><label><input type="radio" name="allergy" value="1" class="uk-radio uk-margin-small-right"
                                                <?php echo e(old('allergy') == '1' ? 'checked' : ''); ?> required> Yes</label></li>
                                <li><label><input type="radio" name="allergy" value="0" class="uk-radio uk-margin-small-right"
                                                <?php echo e(old('allergy') == '0' ? 'checked' : ''); ?>> No</label></li>
                            </ul>
                        </div>
                        <div class="uk-width-1-1@m uk-width-2-3@l">
                            ...
                            <input class="uk-input" type="text" id="kind" name="kind"
                                value="<?php echo e(old('kind')); ?>" hidden>
                        </div>
                        ...
                        <div class="uk-width-1-1@m">
                            ...
                            <ul class="uk-grid uk-grid-small" uk-grid>
                                <li><label><input type="radio" name="reaction" value="1" class="uk-radio uk-margin-small-right"
                                                <?php echo e(old('reaction') == '1' ? 'checked' : ''); ?> required> Yes</label></li>
                                <li><label><input type="radio" name="reaction" value="0" class="uk-radio uk-margin-small-right"
                                                <?php echo e(old('reaction') == '0' ? 'checked' : ''); ?>> No</label></li>
                            </ul>
                        </div>
                        <div class="uk-width-1-1@m">
                            ...
                            <input class="uk-input" type="text" id="reaction_detail" name="reaction_detail"
                                value="<?php echo e(old('reaction_detail')); ?>" hidden>
                        </div>
                    </div>
                </div>
                <div class="uk-booking-footer uk-flex uk-flex-middle uk-flex-center">
            ...
            <div class="uk-booking bg-white uk-border-rounded uk-card uk-card-default  uk-overflow-hidden step">
                ...
                <div class="uk-booking-body">
                    <?php echo $__env->make('themes.default.common.choice', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
                <div class="uk-booking-footer uk-flex uk-flex-middle uk-flex-center">
                    <div>
                        <div>
                ...
                <div class="uk-booking-body">
                    <div>
                        <div class="uk-width-1-1">
                            ...
                            <input class="uk-input" type="text" id="illness" name="illness" placeholder="" value="<?php echo e(old('illness')); ?>" required>
                        </div>
                        ...
                        <div class="uk-flex ">
                            ...
                            <input class="uk-input" type="text" id="doctor" name="doctor" placeholder="" style="width:265px; margin-left:10px;" value="<?php echo e(old('doctor')); ?>" required>
                        </div>
                        ...
                        <div class="uk-flex ">
                            ...
                            <input class="uk-input" type="date" id="signature_date" name="signature_date" placeholder="" style="width:265px; margin-left:10px;" value="<?php echo e(old('signature_date')); ?>" required>
                        </div>
                    </div>
                </div>
                <div class="uk-booking-footer uk-flex uk-flex-middle uk-flex-center">
                ...
                <div class="uk-booking-body">
                    <div>
                        <div class="uk-flex uk-flex-middle">
                            ...
                            <input class="uk-input" type="text" id="practitioner" name="practitioner" placeholder="" style="width:265px; margin-left:10px;" value="<?php echo e(old('practitioner')); ?>" required>
                        </div>
                        ...
                        <ol>
                            <li>The participant,
                                <input class="uk-input w-220" type="text" id="participant" name="participant" placeholder="" value="<?php echo e(old('participant')); ?>" required><span class="text-red">*</span>,
                                age <input class="uk-input w-220" type="number" id="age" name="age" placeholder="" value="<?php echo e(old('age')); ?>" required><span class="text-red">*</span>,
                                has been examined on <input class="uk-input w-220" type="date" id="examine_date" name="examine_date" placeholder="" value="<?php echo e(old('examine_date')); ?>" required><span class="text-red">*</span>.
                            </li>
                            <li>
                                ...
                                <table class="uk-table uk-table-small uk-table-divider">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input class="uk-input uk-width-1-1" type="text" id="height" name="height" placeholder="" value="<?php echo e(old('height')); ?>" required></td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            <td>Weight (lbs / kg)<span class="text-red">*</span></td>
                                            <td><input class="uk-input uk-width-1-1" type="text" id="weight" name="weight" placeholder="" value="<?php echo e(old('weight')); ?>" required></td>
                                        </tr>
                                        <tr>
                                            <td>3</td>
                                            <td>Blood Pressure (SBP / DBP)<span class="text-red">*</span></td>
                                            <td><input class="uk-input uk-width-1-1" type="text" id="pressure" name="pressure" placeholder="" value="<?php echo e(old('pressure')); ?>" required></td>
                                        </tr>
                                        <tr>
                                            <td>4</td>
                                            <td>Pulse (bpm)<span class="text-red">*</span></td>
                                            <td><input class="uk-input uk-width-1-1" type="text" id="pulse" name="pulse" placeholder="" value="<?php echo e(old('pulse')); ?>" required></td>
                                        </tr>
                                        <tr>
                                            <td>5</td>
                                            <td>Respiratory Rate (per min)<span class="text-red">*</span></td>
                                            <td><input class="uk-input uk-width-1-1" type="text" id="respiratory" name="respiratory" placeholder="" value="<?php echo e(old('respiratory')); ?>" required></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </li>
                            <li>
                                <div class="uk-width-1-1">
                                    ...
                                    <input class="uk-input" type="text" id="physical" name="physical" placeholder="" value="<?php echo e(old('physical')); ?>" required>
                                </div>
                            </li>
                            <li class="uk-margin-small-top">
                                <div class="uk-width-1-1">
                                    ...
                                    <input class="uk-input" type="text" id="mental" name="mental" placeholder="" value="<?php echo e(old('mental')); ?>" required>
                                </div>
                            </li>
                            <li class="uk-margin-small-top">
                                <div class="uk-width-1-1">
                                    ...
                                    <ul class="uk-grid uk-grid-small " uk-grid>
                                        <li>
                                            <label>
                                                <input type="radio" id="current_yes" value="1" name="current" class=" uk-radio uk-margin-small-right" <?php echo e(old('current') == '1' ? 'checked' : ''); ?> required>Yes 
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                                                <input type="radio" id="current_no" value="0" name="current" class=" uk-radio uk-margin-small-right" <?php echo e(old('current') == '0' ? 'checked' : ''); ?>>No </label>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="uk-margin-small-top">
                                <div class="uk-width-1-1">
                                    ...
                                    <textarea class="uk-width-1-1 " id="impression" name="impression" rows="4" placeholder="" required><?php echo e(old('impression')); ?></textarea>
                                </div>
                            </li>
                        </ol>
                        <div class="uk-grid">
                            <div class="uk-width-1-2@s uk-margin-small-bottom">
                                ...
                                <input class="uk-input" type="text" id="examiner" name="examiner" placeholder="" value="<?php echo e(old('examiner')); ?>" required>
                            </div>
                            <div class="uk-width-1-2@s uk-margin-small-bottom">
                                <label class="uk-margin-small uk-display-block" for="location">Address<span class="text-red">*</span></label>
                                <input class="uk-input  " type="text" placeholder="" id="location" name="location" value="<?php echo e(old('location')); ?>" required>
                            </div>
                            ...
                            <div class="uk-width-1-1@s uk-margin-small-bottom">
                                ...
                                <input class="uk-input" type="text" id="title" name="title" placeholder="" value="<?php echo e(old('title')); ?>" required>
                            </div>

                            <div class="uk-width-1-2@s uk-margin-small-bottom">
                                <label class="uk-margin-small uk-display-block" for="contact">Phone<span class="text-red">*</span>
                                </label>
                                <input class="uk-input" type="tel" id="contact" name="contact" placeholder="" value="<?php echo e(old('contact')); ?>" required>
                            </div>

                            <div class="uk-width-1-2@s uk-margin-small-bottom">
                                <label class="uk-margin-small uk-display-block" for="doc_email">Email<span class="text-red">*</span>
                                </label>
                                <input class="uk-input  " type="email" placeholder="" id="doc_email" name="doc_email" value="<?php echo e(old('doc_email')); ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="uk-flex ">
                            ...
                            <input class="uk-input" type="date" id="doc_sign_date" name="doc_sign_date" placeholder="" style="width:265px; margin-left:10px;" value="<?php echo e(old('doc_sign_date')); ?>" required>
                        </div>
                    </div>
                </div>
                <div class="uk-booking-footer uk-flex uk-flex-middle uk-flex-center">
...
<?php echo $__env->make('themes.default.common.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\seven_summit\resources\views/themes/default/medical-assessment.blade.php ENDPATH**/ ?>