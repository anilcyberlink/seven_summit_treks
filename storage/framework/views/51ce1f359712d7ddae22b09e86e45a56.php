   ...
   <section class="bg-light uk-section-small uk-position-relative" uk-scrollspy="cls: uk-animation-slide-left-small;  delay: 100; repeat: false;">
      <div class="uk-container ">
         ...
         <!--<div class="uk-hidden@m"> <img src="<?php echo e(asset('uploads/original/'.$settings->first()->mobile_banner_logo)); ?>" alt="" uk-img> </div>-->
                  <div class="uk-hidden@m"> <img src="<?php echo e(asset('images/logos Mobile view-01.png')); ?>" alt="" uk-img> </div>
         <!-- for web device -->
         <!--<div class="uk-visible@m"> <img src="<?php echo e(asset('uploads/original/'.$settings->first()->banner_logo)); ?>" alt="" uk-img> </div>-->
        <div class="uk-visible@m"> <img src="<?php echo e(asset('images/logos web view-02.png')); ?>" alt="" uk-img> </div>
          ...
          <a class="uk-list-shine uk-corner-hover uk-cover-container uk-display-block" tabindex="0" href="<?php echo e(route('page.expeditionlist', $row->uri)); ?>">
            ...
            <div class="uk-position-center">
              <div class="uk-overlay">
                ...
                <p class="uk-margin-remove  text-white"><?php echo $row->sub_title; ?></p>
              </div>
            </div>
          </a>
        </li>
          ...
          <ul class="uk-slider-items uk-grid-small uk-text-center" uk-grid uk-scrollspy="cls: uk-animation-slide-left-small; target:h1, p, img;  delay: 100; repeat: false;">
           ...
           <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="uk-item uk-width-5-6 uk-width-1-2@s uk-width-1-3@m uk-active" tabindex="-1" style="">
              <a class="uk-list-shine uk-corner-hover uk-cover-container uk-display-block" tabindex="0" href="<?php echo e(url(geturl($row->uri))); ?>">
                <div class="uk-media-520">
                    <?php if($row->page_thumbnail): ?>
                        <img class="uk-image" alt="<?php echo e($row->post_title); ?>" uk-img src="<?php echo e($row->page_thumbnail ? asset('uploads/original/' . $row->page_thumbnail) : ''); ?>">
                    <?php endif; ?>
                  <!-- corner -->
                  <div class="uk-corner-borders uk-corner-borders--left"></div>
                  <div class="uk-corner-borders uk-corner-borders--right"></div>
                ...
                <div class="uk-position-center">
                  <div class="uk-overlay">
                    <h1 class="main-title-font  uk-margin-remove text-primary"><?php echo e($row->post_title); ?></h1>
                  </div>
                </div>
              </a>
            </li>
      ...
      <!--<div class="uk-child-width-1-3@s uk-flex-middle uk-text-center uk-grid" uk-grid uk-scrollspy="cls: uk-animation-slide-left-small; target:div;  delay: 300; repeat: false;">-->
        <div class="uk-child-width-expand@s uk-flex-middle uk-text-center uk-grid" uk-grid uk-scrollspy="cls: uk-animation-slide-top-small; target:div, path;  delay: 50; repeat: false;">
         ...
         <div>
            ...
            <img src="<?php echo e(asset('themes-assets/images/ssummit.png')); ?>" style="height:90px; width:auto;">
...
<?php echo $__env->make('themes.default.common.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\seven_summit\resources\views/themes/default/frontpage.blade.php ENDPATH**/ ?>