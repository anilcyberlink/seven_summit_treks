				...
				<div class="uk-card uk-card-default uk-margin-medium-bottom   uk-border-rounded uk-testimonials-list">
					<div class="uk-card-header uk-bg-pattern-primary">
						<div class="uk-text-center">
							...
							<h2 class=" uk-h3 uk-margin-small uk-margin-remove-bottom theme-font-extra-bold"><?php echo e($row->name); ?></h2>
							<h2 class="text-primary  uk-margin-small uk-margin-remove-top   uk-h4"><?php echo e($row->country); ?></h2>
