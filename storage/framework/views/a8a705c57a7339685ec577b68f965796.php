				...
				<div class="uk-width-1-4@m uk-visible@m">
					...
					<div class="uk-blog-sidebar " style="z-index: 9;" uk-sticky="offset: 100; bottom: #uk-stop-sticky">
						...
						<div>
							...
							<a href="<?php echo e($row->external_link); ?>" class="<?php echo e($row->uri ==  Request::segment(2)?'uk-active':''); ?>"> <?php echo e($row->page_title); ?> </a> 
							<?php else: ?>
							<a href="<?php echo e(url('info/'.$parent->uri.'/'.teamurl($row['uri'],$row['page_key']))); ?>" class="<?php echo e($row->uri ==  Request::segment(2)?'uk-active':''); ?>"> <?php echo e($row->page_title); ?> </a> 
							<?php endif; ?>
							</li>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							</ul>
