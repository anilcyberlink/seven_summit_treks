                            ...
                            <table class="table admin-form table-striped dataTable" id="datatable3">
                                ...
                                <?php if(count($all) > 0): ?>
                                    ...
                                    <tr class="bg-light">
                                        ...
                                        <td class=""><?php echo e(($row->email)); ?> -  <?php if(($row->verified)==0): ?>
                                ...
                                <td class="text-left">
                                    <span class="trash"> <a href="<?php echo e(route('subscriber.delete',$row->id)); ?>" onclick="return confirm('Confirm Delete?')" class="btn-btn-danger"><i
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\seven_summit\resources\views/admin/subscriber/index.blade.php ENDPATH**/ ?>