        ...
        <div class="panel-body">
            <div class="form-group">
                <div class="col-lg-12">
                    ...
                    <textarea class="form-control" name="meta_title" rows="1" placeholder="Meta Title"><?php echo e($data->meta_key); ?></textarea>
            ...
            <div class="form-group">
                <div class="col-lg-12">
                    ...
                    <textarea class="form-control" name="meta_description" rows="2" placeholder="Meta Description"><?php echo e($data->meta_description); ?></textarea>
